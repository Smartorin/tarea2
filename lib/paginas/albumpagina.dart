...
class _AlbumPaginaState extends State<AlbumPagina> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(//Inicio Al abrir la imagen desplega esta pantalla de informacion
      backgroundColor: Color.fromARGB(255, 17, 13, 13),
       appBar: AppBar(
  ...
  } //Fin Al abrir la imagen desplega esta pantalla de informacion
  //El reproductor

Widget DetalleImagen(){
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Row(
                children: List.generate(imgb3.length, (index) {
                  return Padding(
